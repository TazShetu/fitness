...
@section('breadcrumb')
    <ul class="breadcrumb">
        <li>Videos</li>
        <li><a href="{{route('video.category')}}">Category</a></li>
        <li class="active">Edit</li>
    </ul>
@endsection
@section('pageTitle', 'Video Category Edit')
@section('content')
    <div class="row mb-5">
        ...
        <div class="col-lg-8 offset-lg-2">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Video Category Edit</h3>
                </div>
                {{--     Form Start              --}}
                <form action="{{route('video.category.update', ['cid' => $cedit->id])}}" class="form-horizontal"
                      method="post">
                    @csrf
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($c->id != $cedit->id)
                                        ...
                                        <form action="{{route('video.category.delete', ['cid' => $c->id])}}"
